...
我們將 GitHub Copilot coding agent 的強大能力直接帶進你的終端機。有了 GitHub Copilot CLI，你可以在本機與一個理解你的程式碼和 GitHub 情境的 AI agent 同步協作。
...
- **Agentic 能力：** 與能夠規劃並執行複雜任務的 AI 協作者一起建置、編輯、除錯和重構程式碼。
- **MCP 驅動的擴充能力：** 善用 coding agent 預設隨附的 GitHub MCP server，並支援自訂 MCP servers 來擴充能力。
- **完整掌控：** 每個動作都能在執行前先預覽，沒有你的明確批准就不會發生任何事。

我們仍在旅程的早期階段，但在你的回饋協助下，我們正快速迭代，致力讓 GitHub Copilot CLI 成為你終端機中最理想的夥伴。
...
如果你是透過組織或企業取得 GitHub Copilot 的存取權，當你的組織擁有者或企業管理員在組織或企業設定中停用 GitHub Copilot CLI 時，你就無法使用 GitHub Copilot CLI。更多資訊請參閱 [Managing policies and features for GitHub Copilot in your organization](http://docs.github.com/copilot/managing-copilot/managing-github-copilot-in-your-organization/managing-github-copilot-features-in-your-organization/managing-policies-for-copilot-in-your-organization)。
...
第一次啟動時，你會看到我們可愛的動態橫幅。如果你想再次看到這個橫幅，請在啟動 `copilot` 時加上 `--banner` 旗標。
...
GitHub Copilot CLI 支援 Language Server Protocol (LSP)，可提供更強的程式碼智慧功能。這項功能提供像是前往定義、懸停資訊與診斷等智慧型程式碼能力。
...
我們開發速度很快。預期會有頻繁更新，請讓你的用戶端保持最新，以取得最新功能與修正！
