...
GitHub Copilot CLI 將 AI 驅動的程式設計協助直接帶到你的命令列，讓你能透過自然語言對話來建置、除錯與理解程式碼。它採用與 GitHub Copilot 編碼代理相同的代理式執行框架，在與你的 GitHub 工作流程深度整合的同時，提供智慧輔助功能。
...
- **MCP 驅動的可擴充性：** 充分利用編碼代理預設隨附 GitHub MCP 伺服器這項特性，並支援自訂 MCP 伺服器來擴充能力。
