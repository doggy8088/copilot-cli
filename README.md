...
GitHub Copilot CLI 直接把 AI 驅動的程式設計協助帶進命令列，讓你能透過自然語言對話建置、除錯並理解程式碼。它由與 GitHub 的 Copilot coding agent 相同的代理式執行框架驅動，在深度整合你的 GitHub 工作流程的同時，提供智慧協助。
...
我們正把 GitHub Copilot coding agent 的強大能力直接帶進你的終端機。透過 GitHub Copilot CLI，你可以在本機同步與一個理解你的程式碼與 GitHub 情境的 AI 代理協作。
...
- **MCP 驅動的擴充性：** 善用 coding agent 預設隨附的 GitHub MCP 伺服器，並支援自訂 MCP 伺服器來擴充能力。
