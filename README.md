...
我們正把 GitHub Copilot coding agent 的能力直接帶進你的終端機。有了 GitHub Copilot CLI，你可以在本機以同步方式與一個了解你的程式碼與 GitHub 情境的 AI 代理協作。
...
- **由 MCP 驅動的可擴充性：** 受惠於 coding agent 預設隨附 GitHub 的 MCP server，並支援自訂 MCP servers 來擴充能力。
