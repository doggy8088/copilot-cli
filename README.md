...
GitHub Copilot CLI 將 AI 驅動的程式設計協助直接帶到你的命令列，讓你能透過自然語言對話來建置、除錯與理解程式碼。它採用與 GitHub 的 Copilot coding agent 相同的 agentic harness，能在深度整合 GitHub 工作流程的同時，提供智慧化協助。
...
我們正把 GitHub Copilot coding agent 的強大能力直接帶到你的終端機中。透過 GitHub Copilot CLI，你可以在本機同步與一個理解你的程式碼與 GitHub 情境的 AI agent 協作。
