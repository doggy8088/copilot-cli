...
我們正將 GitHub Copilot coding agent 的強大能力直接帶進你的終端機。有了 GitHub Copilot CLI，你可以在本機與一位理解你的程式碼與 GitHub 情境的 AI 代理同步協作。
...
- **完整掌控：** 在執行前預覽每一個動作，沒有你的明確核准，任何事都不會發生。

我們仍處於旅程的早期階段，但在你的回饋協助下，我們正快速迭代，目標是讓 GitHub Copilot CLI 成為你終端機中最理想的協作夥伴。
