...
GitHub Copilot CLI 將 AI 驅動的程式設計協助直接帶到你的命令列，讓你能透過自然語言對話建置、除錯並理解程式碼。它由與 GitHub Copilot coding agent 相同的代理式執行架構提供支援，在深度整合你的 GitHub 工作流程的同時，提供智慧協助。
...
我們正將 GitHub Copilot coding agent 的能力直接帶到你的終端機。透過 GitHub Copilot CLI，你可以在本機與一位理解你的程式碼與 GitHub 情境的 AI 代理同步協作。
...
- **MCP 驅動的可擴充性：** 善用 coding agent 預設附帶 GitHub MCP server，並支援自訂 MCP servers 來延伸能力。
