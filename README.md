...
- **MCP 驅動的可擴充性：** 善用 coding agent 預設搭載的 GitHub MCP server，並支援自訂 MCP servers 以擴充能力。
...
GitHub Copilot CLI 支援 Language Server Protocol (LSP)，以提供更強的程式碼智慧功能，例如跳至定義、懸停資訊與診斷。
