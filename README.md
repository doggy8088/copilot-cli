...
GitHub Copilot 的強大能力，現在來到你的終端機中。
...
我們正把 GitHub Copilot 編碼代理的能力直接帶到你的終端機。透過 GitHub Copilot CLI，你可以在本機與一個理解你的程式碼及 GitHub 脈絡的 AI 代理同步協作。
...
- **MCP 驅動的可擴充性：** 善用編碼代理預設隨附 GitHub MCP server 的優勢，並支援自訂 MCP servers 來擴充能力。
